...
function Footer() {
    ...
    return <>
        ...
        <div className='container-footer'>
            ...
            <span>Copyright &copy; {1900 + new Date().getYear()} , todos os direitos reservados Itabaú - Site Desenvolvido por <a href='https://luiss1569.github.io/luiss1569.github.io' target='_blank' rel="noreferrer">Luis Ricardo</a></span>
        </div>
    </>;
}
